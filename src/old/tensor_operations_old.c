...
TensorError elementwise_broadcast(Tensor* out, Tensor* a, Tensor* b) {
    ...
    tensor_broadcast_to(a,out->shape,out->ndim, false);
    tensor_broadcast_to(b, out->shape, out->ndim, false);
